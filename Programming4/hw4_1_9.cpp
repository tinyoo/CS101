...
void Jump( int a, int b, AVLTree Xs, int *Sequence, int num_x,  int n, int *Ans );
...
void IOI( int a, int b, AVLTree Xs, int *Sequence, int num_x,  int n, int *Ans )
{
    ...
    if ( b - a <= 6 )
    {
        ...
        //Jump( mid, b, Xs, Sequence, num_x, n, Ans );
    }
    else
    {
        IOI(a, mid, Xs, Sequence, num_x, n, Ans);
        IOI(mid, b, Xs, Sequence, num_x, n, Ans);
        //Jump( a, b, Xs, Sequence, num_x, n, Ans );
    }
    //Jump( a, b, Xs, Sequence, num_x, n, Ans );
}
...
void Jump( int a, int b, AVLTree Xs, int *Sequence, int num_x,  int n, int *Ans )
{
    ...
    Change(a, b, Xs, Sequence, temp3, num_x, n, Ans);
    int i = mid - 1;
    while ( i >= a )
    {
        int j = mid;
